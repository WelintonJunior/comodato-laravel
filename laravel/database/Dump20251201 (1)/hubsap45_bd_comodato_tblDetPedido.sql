...
CREATE TABLE `tblDetPedido` (
  ...
  `detPedIdProduto` int(11) NOT NULL,
  `detPedIdMovimento` int(11) NOT NULL,
  `detPedProQtd` decimal(15,3) NOT NULL,
  `detPedHora` time NOT NULL,
  `detPedProPreco` decimal(12,2) DEFAULT NULL,
...
-- Dump completed on 2025-12-01 14:51:02
