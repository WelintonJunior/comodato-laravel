    ...
    <div class="topbar-inner" x-data="{ open: false }">
      <div class="nav-group">
        <div class="relative">
          ...
          <div x-show="open" x-transition @click.outside="open = false" class="submenu absolute"
            style="white-space:nowrap;">

            <!-- Resource existente: Vendedores -->
            <a href="{{ route('filament.admin.resources.vendedors.list') }}"
              class="main-btn {{ request()->routeIs('filament.admin.resources.vendedors.*') ? 'active' : '' }}">
              Vendedores
            </a>

            <!-- Resource existente: Produtos -->
            <a href="{{ route('filament.admin.resources.produtos.list') }}"
            ...
            <a href="{{ route('filament.admin.resources.fornecedors.list') }}"
              class="main-btn {{ request()->routeIs('filament.admin.resources.fornecedors.*') ? 'active' : '' }}">
              Fornecedores
            </a>

            <!-- Resource existente: Entradas -->
            <a href="{{ route('filament.admin.resources.entradas.list') }}"
        ...
        <a href="{{ route('filament.admin.pages.sorteio') }}"
          class="main-btn {{ request()->routeIs('filament.admin.pages.sorteio') ? 'active' : '' }}">
          Sorteio
        </a>

        <form method="POST" action="{{ route('filament.admin.auth.logout') }}" class="logout-form">
          @csrf
